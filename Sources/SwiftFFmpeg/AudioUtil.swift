...
public struct AVChannel: Equatable, CustomStringConvertible {
    ...
    public static let frontLeft = AVChannel(rawValue: UInt64(AV_CHAN_FRONT_LEFT.rawValue))
    public static let frontRight = AVChannel(rawValue: UInt64(AV_CHAN_FRONT_RIGHT.rawValue))
    public static let frontCenter = AVChannel(rawValue: UInt64(AV_CHAN_FRONT_CENTER.rawValue))
    public static let lowFrequency = AVChannel(rawValue: UInt64(AV_CHAN_LOW_FREQUENCY.rawValue))
    public static let backLeft = AVChannel(rawValue: UInt64(AV_CHAN_BACK_LEFT.rawValue))
    public static let backRight = AVChannel(rawValue: UInt64(AV_CHAN_BACK_RIGHT.rawValue))
    public static let frontLeftOfCenter = AVChannel(rawValue: UInt64(AV_CHAN_FRONT_LEFT_OF_CENTER.rawValue))
    public static let frontRightOfCenter = AVChannel(rawValue: UInt64(AV_CHAN_FRONT_RIGHT_OF_CENTER.rawValue))
    public static let backCenter = AVChannel(rawValue: UInt64(AV_CHAN_BACK_CENTER.rawValue))
    public static let sideLeft = AVChannel(rawValue: UInt64(AV_CHAN_SIDE_LEFT.rawValue))
    public static let sideRight = AVChannel(rawValue: UInt64(AV_CHAN_SIDE_RIGHT.rawValue))
    public static let topCenter = AVChannel(rawValue: UInt64(AV_CHAN_TOP_CENTER.rawValue))
    public static let topFrontLeft = AVChannel(rawValue: UInt64(AV_CHAN_TOP_FRONT_LEFT.rawValue))
    public static let topFrontCenter = AVChannel(rawValue: UInt64(AV_CHAN_TOP_FRONT_CENTER.rawValue))
    public static let topFrontRight = AVChannel(rawValue: UInt64(AV_CHAN_TOP_FRONT_RIGHT.rawValue))
    public static let topBackLeft = AVChannel(rawValue: UInt64(AV_CHAN_TOP_BACK_LEFT.rawValue))
    public static let topBackCenter = AVChannel(rawValue: UInt64(AV_CHAN_TOP_BACK_CENTER.rawValue))
    public static let topBackRight = AVChannel(rawValue: UInt64(AV_CHAN_TOP_BACK_RIGHT.rawValue))
    /// Stereo downmix.
    public static let stereoLeft = AVChannel(rawValue: UInt64(AV_CHAN_STEREO_LEFT.rawValue))
    /// See AV_CH_STEREO_LEFT.
    public static let stereoRight = AVChannel(rawValue: UInt64(AV_CHAN_STEREO_RIGHT.rawValue))
    public static let wideLeft = AVChannel(rawValue: UInt64(AV_CHAN_WIDE_LEFT.rawValue))
    public static let wideRight = AVChannel(rawValue: UInt64(AV_CHAN_WIDE_RIGHT.rawValue))
    public static let surroundDirectLeft = AVChannel(rawValue: UInt64(AV_CHAN_SURROUND_DIRECT_LEFT.rawValue))
    public static let surroundDirectRight = AVChannel(rawValue: UInt64(AV_CHAN_SURROUND_DIRECT_RIGHT.rawValue))
    public static let lowFrequency2 = AVChannel(rawValue: UInt64(AV_CHAN_LOW_FREQUENCY_2.rawValue))
}
